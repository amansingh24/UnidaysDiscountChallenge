...
public class UnidaysDiscountChallenge {
	...
	public int CalculateTotalPrice (ArrayList <Item> myList) { //this calculates the total price of the items in the basket
		...
		while (z < myList.size()) { //loops through the basket again
			...
			finalPrice = finalPrice + obj1.getPrice(tempPrice,tempProductCount,letter); //calculates the finalPrice using the pricing rules class
		...
		System.out.println("This delivery charge for this order is: " + obj1.deliveryCharge(finalPrice) + " GBP" );
		finalPrice = finalPrice + obj1.deliveryCharge(finalPrice); //adds on the deliveryCharge.
